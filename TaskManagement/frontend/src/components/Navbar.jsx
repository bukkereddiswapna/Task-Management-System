...
function Navbar() {
    return (
        <nav className="navbar navbar-expand-lg navbar-dark" style={{ background: "linear-gradient(135deg, #715bc9 0%, #684AE2 100%) ", marginLeft: "calc(-50vw + 50%)", width: "100vw",height:"90px", padding: "0" }}>
