...
function Dashboard() {
  ...
  // Unified numbers state tracking
  ...
  // Dynamic config map to render cards safely
  const statCardsData = [
  ...
  return (
    <div style={page}>
      {/* This forcefully injects CSS to turn any text under your large numbers white */}
      <style>{`
...
// Global Theme Stylesheet Object Configurations
const colors = {
  bgBase: "#F8FAFC",
...
const statLabel = {
  ...
  fontSize: "0.95rem",
  fontWeight: "600",
  opacity: 0.95, // Keeps text sharp and readable
};
